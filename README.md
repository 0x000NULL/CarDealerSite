...
<img src="docs/assets/dealership_.png" height="300" alt="CarsNV" /><br>
<img src="docs/assets/CarsNV.png" height="80" alt="CarsNV" />
...
3. Create a database named `CarsNV`
4. Create all the required `collections` in the created database and fill in the data from `db_data`


#### Local
1. Inside  `--> app.js` under MongoDB section, replace the url with `mongodb://localhost:27017/CarsNV`
